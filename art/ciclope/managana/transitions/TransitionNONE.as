package art.ciclope.managana.transitions {
	 ...
	 * TransitionNONE provides methods for enabling dis folder streams change without transitions.
	 * @author Lucas Junqueira - lucas@ciclope.art.br
	 */
	public class TransitionNONE {
		...
		public function setIN(image:ManaganaImage):void {
			// do nothing: keep at original place
		}
